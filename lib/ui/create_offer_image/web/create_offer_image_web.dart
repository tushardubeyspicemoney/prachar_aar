...
class CreateOfferImageWeb extends ConsumerStatefulWidget {
  const CreateOfferImageWeb({
    Key? key,
  }) : super(key: key);
...
class _CreateOfferTextWebState extends ConsumerState<CreateOfferImageWeb> {
  ///Init Override
  @override
  void initState() {
    super.initState();
