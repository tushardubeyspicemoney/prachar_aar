...
class EditOfferTextMobile extends ConsumerStatefulWidget {
  const EditOfferTextMobile({
    Key? key,
  }) : super(key: key);
...
class _CreateOfferTextMobileState extends ConsumerState<EditOfferTextMobile> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20.h),
                    SizedBox(height: MediaQuery.of(context).size.height / 4, child: radioListWidget()),
                    dividerWidget(),
                    SizedBox(height: 20.h),
                    CommonText(
        ...
        Padding(
          ...
          child: CommonButton(
            ...
            onTap: () async {
              ...
              ref.read(navigationStackProvider).push(const NavigationStackItem.editOfferImage());
            },
