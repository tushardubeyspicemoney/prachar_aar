...
class OfferMobile extends ConsumerStatefulWidget {
  const OfferMobile({Key? key}) : super(key: key);

  @override
  ConsumerState<OfferMobile> createState() => _OfferMobileState();
}

class _OfferMobileState extends ConsumerState<OfferMobile> with AutomaticKeepAliveClientMixin {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CommonText(
                          title: "${offerWatch.offerTextController.text.length}/110",
              ...
              child: GestureDetector(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: offerWatch.offers![index]!.offerDesc,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          /// Hide Edit Button
          /*offerWatch.isContactUsFieldEditable?GestureDetector(
            onTap: () async{
              offerWatch.updateIsContactUsFieldEditable(
