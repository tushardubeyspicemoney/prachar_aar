...
class OfferWeb extends ConsumerStatefulWidget {
  const OfferWeb({Key? key}) : super(key: key);

  @override
  ConsumerState<OfferWeb> createState() => _OfferWebState();
}

class _OfferWebState extends ConsumerState<OfferWeb> with AutomaticKeepAliveClientMixin {
